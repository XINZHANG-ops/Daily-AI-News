...
- [[topics/llm_models]] — June 8: "super app" transformation (combining ChatGPT, Codex, AI browser) is the right strategic response to Claude's 1,858% growth and Gemini's Workspace expansion, but every month of delay entrenches competitors
- [[sources/anthropic]] — June 8: Claude's 1,858% YoY usage growth is the largest absolute jump in any single quarter; OpenAI is now the #2 in enterprise growth, behind Anthropic's enterprise/API base
