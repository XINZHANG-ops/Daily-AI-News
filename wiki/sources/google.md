...
| 2026-03-26 | NotebookLM integrated into Gemini | AI research assistant now native to Gemini |
| 2026-03-28 | Gemini 3.1 Flash Live released | Real-time multimodal voice, sub-300ms latency |
| 2026-03-29 | Apple gains complete Gemini access | Deeper partnership than previously known |
| 2026-04-02 | Gemma 4 (Apache 2.0) released | Four variants, 31B ranks #3 on Arena AI |
| 2026-04-07 | Gemini CLI official open-source release | Terminal agent with 1M context, MCP support |
| 2026-04-07 | NotebookLM memory import tool | Helping users switch from ChatGPT |
| 2026-04-08 | Gemini 3 Deep Think for Ultra | Harder technical use cases positioning |
...
| 2026-05-19 | Gemini 3.5 and Gemini Spark launched | Gemini 3.5 family combines frontier intelligence with action; Gemini Spark is 24/7 personal AI agent |
...
- [[sources/anthropic]] — June 8: Claude's 1,858% YoY usage growth is the largest single-quarter absolute jump; the "three frontier labs all profitable-or-near" claim depends on Google closing the gap on ChatGPT consumer
- [[sources/openai]] — June 8: Gemini's challenge to ChatGPT is structurally different (free, hardware-bundled, 3B+ user-surface-integrated); Pixel 9+ Gemini Nano on-device is the un-priced moat OpenAI cannot match
- [[entities/gemini-3]] — June 8: combined with Gemini 3.5 Flash and Antigravity platform, the "free + hardware-bundled + surface-integrated" combination is the structural defense against ChatGPT consumer dominance
