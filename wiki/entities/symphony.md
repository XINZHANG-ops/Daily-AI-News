...
- [[entities/andrej-karpathy-skills]] — Complements Symphony by optimizing individual agent behavior (CLAUDE.md principles), while Symphony handles fleet-level orchestration
