...
## What It Is
Perplexity Computer is an always-on AI assistant that runs locally on Mac, launched April 17, 2026. It manages files, controls native apps like iMessage and Calendar, and browses web autonomously. Available exclusively to Perplexity Max subscribers at $200/month. Designed to run continuously on a dedicated Mac mini.
...
| Creator | Perplexity |
| Pricing | $200/month (Max subscribers only) |
| Platform | Mac (local) |
| Hardware | Designed for Mac mini |
...
- [[ideas/agent-control-interface-wars]] — Perplexity's local context model (your files + web) represents a third philosophy alongside Google's controllable agents and OpenAI's autonomous agents — trust through data locality rather than approval gates or continuous execution