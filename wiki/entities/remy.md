...
- [[ideas/agent-control-interface-wars]] — Remy embodies the control-vs-autonomy schism: Google's enterprise safety requirements demand fine-grained user control over every agent action, while competitors like Anthropic and OpenAI bet that autonomous speed wins market share — Remy is the test case for whether safety-first design can compete with speed-first deployment
