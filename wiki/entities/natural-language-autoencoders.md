...
- [[entities/dexter]] — The "Claude Code for finance" repo reflects the same verticalization impulse driving Anthropic's 10 finance agents, both predicated on the assumption that financial workflows require audit trails
