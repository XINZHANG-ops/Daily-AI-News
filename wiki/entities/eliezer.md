...
- [[entities/ouroboros]] — Both Eliezer and ouroboros treat agents as systems that evolve their own behavior; Eliezer does it through code mutation, ouroboros through declarative specification — two paths to the same goal of reducing human prompt engineering
