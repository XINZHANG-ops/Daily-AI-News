...
## What It Is
Google's advanced reasoning mode for Gemini 3 Ultra, providing extended test-time compute for complex analytical tasks. In April 2026, it identified logical flaws in peer-reviewed mathematics papers that had cleared human expert review — a demonstration of AI reasoning surpassing human peer review in specialized domains.
...
|-----------|-------|
| Creator | Google |
| Base Model | Gemini 3 Ultra |
| Key Capability | Extended test-time reasoning |
| Milestone | Found flaws in peer-reviewed math papers |
| Revealed | April 21, 2026 |
